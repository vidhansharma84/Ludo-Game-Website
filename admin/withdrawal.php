...
<section id="requests" class="mt-8 lg:mt-12">
                    <h2 class="text-2xl lg:text-3xl font-bold mb-6 text-gray-800">Withdraw Requests</h2>
                    <div class="bg-white shadow-md rounded-lg overflow-hidden overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Transfer Method</th>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="px-4 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div class="ml-4">
                                                            <div class="text-sm font-medium text-gray-900"><?php echo $row['screenshot']; ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-4 whitespace-nowrap">
